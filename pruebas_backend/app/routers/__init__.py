...
from . import aplicacion, pantalla, funcionalidad, so, tipo_prueba, tipo_usuario, caso_prueba, tester, proceso, testers_proceso, funcionalidades_proceso
...
router.include_router(tester.router, prefix="/tester", tags=["tester"])
